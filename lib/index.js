...
var METHODS = ['keys', 'values', 'contains', 'count', 'has', 'get', 'sum', 'avg', 'each', 'slice', 'reduce', 'toArray', 'chunk', 'except', 'filter', 'isEmpty', 'isNotEmpty', 'first', 'last', 'map', 'mapWithKeys', 'flatten', 'min', 'max', 'only', 'pipe', 'pluck', 'reject', 'swap', 'shuffle', 'take', 'unique', 'diff', 'diffKeys', 'intersect', 'intersectByKeys', 'merge', 'keyBy', 'groupBy', 'sort', 'sortBy', 'append', 'prepend', 'index', 'insert', 'join', 'partition'];